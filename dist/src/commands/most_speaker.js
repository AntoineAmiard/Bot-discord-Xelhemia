...
class MostSpeaker {
    ...
    async execute(message) {
        ...
        const mostSpeaker = [...users.entries()].sort((a, b) => a[1] - b[1]);
        console.log('finally =>' + mostSpeaker[mostSpeaker.length - 1][1]);
        await message.channel.send(`Et voila ! Le mollusque causeur des 3 derniers mois est <@${mostSpeaker[0][0].id}>`);
    }
    help() {
        return 'Display pong';
    }
